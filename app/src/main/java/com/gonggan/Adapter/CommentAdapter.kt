...
class CommentAdapter(private val context: Context, private val dataset: List<CommentData>, private val update : () -> Unit, private val sysDocNum : String, private val token : String):
